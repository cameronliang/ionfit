...
if __name__ == '__main__':
    ...
    input_path = '/data/jwliang/projects_data/obs/uv_qsos/COS_QSOs/'+qso_name+'/reduced/bvp_chains_' + str(redshift) + '/posterior'
    

    #input_path = input_path + '/bvp_chains_' + str(redshift) + '/posterior'
    #print input_path
